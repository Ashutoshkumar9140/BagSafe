      ...
      <div className="max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-2xl bg-white shadow-2xl dark:bg-slate-900">
        ...
        <div className="flex items-center justify-between border-b border-slate-200 px-6 py-5 dark:border-slate-700">
          <div className="flex items-center gap-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-orange-100 text-2xl dark:bg-orange-950/40">
              🏠
            </div>
          ...
          <button
            ...
            className="rounded-lg px-3 py-2 text-2xl text-slate-400 transition hover:bg-slate-100 hover:text-slate-700
             dark:text-slate-500 dark:hover:bg-slate-700"
          >
            ×
          </button>
        </div>
        ...
        <div className="p-6">
          {message && (
            <div
              className="mb-6 rounded-lg border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-700
          ...
          {!editing ? (
            <>
              ...
              <section className="mt-8 border-t border-slate-200 pt-6 dark:border-slate-700">
                ...
                <div className="mt-5 flex flex-col gap-3 sm:flex-row">
                  <button
                    ...
                    className="rounded-lg bg-blue-600 px-5 py-3 text-sm font-semibold text-white transition hover:bg-blue-700 dark:hover:bg-blue-500"
                  >
                    Edit Profile
                  </button>
              ...
              {showDeleteBox && (
                <section className="mt-6 rounded-xl border border-red-200 bg-red-50 p-5 dark:border-red-900 dark:bg-red-950/40">
                  ...
                  <form onSubmit={handleDeleteAccount} className="mt-5">
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border border-red-200 bg-white px-4 py-3 outline-none
                       focus:border-red-500 focus:ring-2 focus:ring-red-100 dark:border-red-900 dark:bg-slate-900
                        dark:focus:border-red-400 dark:focus:ring-red-900/50"
                    />
                    ...
                    <div className="mt-4 flex flex-col gap-3 sm:flex-row">
                      ...
                      <button
                        ...
                        className="rounded-lg border border-slate-300 bg-white px-5 py-3 text-sm font-semibold
                         text-slate-700 transition hover:bg-slate-50 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-300"
                      >
                        Cancel
                      </button>
                    </div>
            ...
            <form onSubmit={handleSave}>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full rounded-lg border border-slate-300 bg-white px-4 py-3 outline-none transition
                     focus:border-blue-500 focus:ring-2 focus:ring-blue-100 dark:border-slate-600 dark:bg-slate-900
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                ...
                <button
                  ...
                  className="rounded-lg border border-slate-300 px-6 py-3 font-semibold text-slate-700 transition
